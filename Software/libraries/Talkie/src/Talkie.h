...
#define TALKIE_MAX_FRAME_HISTORY 32
extern uint8_t frameHistory[TALKIE_MAX_FRAME_HISTORY][12];
extern int frameHistoryLen;
extern int stretchRepeat, stretchRepeatCounter, lastFrameUsed;
...
public:
    ...
    typedef void (*GateCallbackFunc)(bool gateOn);
    static void setGateCallback(GateCallbackFunc cb);
...
private:
    ...
    static GateCallbackFunc gateCallback;
};
